...
Simu_Ext <- lapply(Simu, FUN=function(sim_, alphas_=c(1, 2)){
...
for(sim_ext in Simu_Ext){
    ...
    colnames(data_to_show)[1] <- "Met"
     ...
     essai <- kable(data_to_show, row.names = FALSE,  align="c", format="html", 
              ...
              row_spec(c(1, 9, 10), bold = T, color = "white", background = "#00FF00") %>%
              row_spec(c(3, 5, 6), bold = T, color = "white", background = "#A9F5A9")
     print(essai)
  }
...
for(sim_ext in Simu_Ext){
    ...
    colnames(data_to_show)[1] <- "Met"
     ...
     essai <- kable(data_to_show, row.names = FALSE,  align="c", format="html",
              ...
              add_header_above(c(" " = 1, "Time" = nb_lg, "MSE" = nb_lg, "E(K=K*)" = nb_lg, "ARI" = nb_lg)) %>%
              column_spec((1:nb_so-1)*nb_lg+1, border_right = T) %>%
              row_spec(c(1, 9, 10), bold = T, color = "white", background = "#2E2EFE") %>%
              row_spec(c(3, 5, 6), bold = T, color = "white", background = "#A9BCF5")
     print(essai)
  }
...
for(sim_ext in Simu_Ext){
    ...
    colnames(data_to_show)[1] <- "Met"
     ...
     essai <- kable(data_to_show, row.names = FALSE,  align="c", format="html",
              ...
              add_header_above(c(" " = 1, "Time" = nb_lg, "MSE" = nb_lg, "E(K=K*)" = nb_lg, "ARI" = nb_lg)) %>%
              column_spec((1:nb_so-1)*nb_lg+1, border_right = T)  %>%
              row_spec(c(1, 9, 10), bold = T, color = "white", background = "#D7261E") %>%
              row_spec(c(3, 5, 6), bold = T, color = "white", background = "#F5A9A9")
     print(essai)
  }
```
